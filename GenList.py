...
#angle array and np.sin(angle) array
angle = np.linspace(0,2*np.pi,iter,endpoint=False)   # values of t

# ------------------------------------------------------------------------------
#3 : Making a model for hall volatge
# ------------------------------------------------------------------------------
...
def V_out(n,J,B,T): return V_hall(n,J,B,T)+V_phe(n,J,B)+noise
